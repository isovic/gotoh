...
AlignHirsch::AlignHirsch(const std::string& q, const std::string& t, Penalties p,
             AlignType aln_type, GlobalMargins gm)
    : AlignHirsch(q.c_str(), q.size(), t.c_str(), t.size(), p, aln_type, gm) {
}

AlignHirsch::AlignHirsch(const char* q, int64_t ql, const char* t, int64_t tl, Penalties p,
...
AlignHirsch::~AlignHirsch() {

}

int AlignHirsch::GetAlignment(int32_t &q_start, int32_t &q_end, int32_t &t_start, int32_t &t_end, int32_t &score, std::vector<CigarOp> &cigar) {
	cigar = cigar_;
	q_start = q_start_;
	q_end = q_end_;
	t_start = t_start_;
...
void AlignHirsch::FormatAlignment(const std::string &q, const std::string &t, std::string &alnq, std::string &alnt, std::string &alnm) {
	CigarToAlignment(q.c_str(), q.size(), q_start_, q_end_, t.c_str(), t.size(), t_start_, t_end_, aln_type_, cigar_, alnq, alnt, alnm);
}

void AlignHirsch::Verbose(const std::string &q, const std::string &t, std::ostream &os) {
...
int AlignHirsch::Align_(const char* q, int64_t ql, const char* t, int64_t tl, Penalties p, GlobalMargins gm, AlignType aln_type,
...
int AlignHirsch::AlignGlobal_(const char* q, int64_t ql, const char* t, int64_t tl, Penalties p, GlobalMargins gm,
                       int32_t &q_start, int32_t &q_end, int32_t &t_start, int32_t &t_end, int32_t &score, std::vector<is::CigarOp> &cigar) {
...
int AlignHirsch::AlignLocal_(const char* q, int64_t ql, const char* t, int64_t tl,
                      Penalties p) {
  return 0;
}

int AlignHirsch::Traceback_(const char* q, int64_t ql, const char* t, int64_t tl,
